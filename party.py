...
def get_treats():
    ...
    return [
        {"type": "dessert", "description": "Chocolate mousse", "who": "Leslie"},
        {"type": "dessert", "description": "Cardamom-Pear pie", "who": "Joel"},
        {"type": "appetizer", "description": "Humboldt Fog cheese", "who": "Meggie"},
        {"type": "dessert", "description": "Lemon bars", "who": "Bonnie"},
        {"type": "appetizer", "description": "Mini-enchiladas", "who": "Katie"},
        {"type": "drink", "description": "Sangria", "who": "Anges"},
        {"type": "dessert", "description": "Chocolate-raisin cookies", "who": "Henry"},
        {"type": "dessert", "description": "Brownies", "who": "Sarah"},
    ]
...
def show_treats():
    ...
    return render_template("treats.html", treats=treats, most=most, least=least)
